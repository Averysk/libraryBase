...
object StringDesignUtil {
     ...
     */
    fun getSpannableStringBuilder(text: String, color: Int, startIndex: Int, entIndex: Int): SpannableStringBuilder {
     ...
     */
    fun getSpannableStringBuilder(text: String, texts: Array<String>?, color: IntArray?): SpannableStringBuilder {
        val builder = SpannableStringBuilder(text)
        if (texts != null) {
     ...
     */
    fun getSpannableStringBuilder(text: Array<String?>?, color: IntArray?): SpannableStringBuilder {
