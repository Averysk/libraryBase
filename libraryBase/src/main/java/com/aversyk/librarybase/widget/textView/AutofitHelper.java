package com.aversyk.librarybase.widget.textView;
...
public class AutofitHelper {
    ...
    public static AutofitHelper create(TextView view, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            sizeToFit = ta.getBoolean(R.styleable.AutofitTextView_autofitSizeToFit, true);
            minTextSize = ta.getDimensionPixelSize(R.styleable.AutofitTextView_autofitMinTextSize, minTextSize);
